...
void Signatures::FindAll() {
	...
	/* CBaseFileIO */
	pointerMap[Sigs::CBaseFileIO_FileExists] = Signatures::FindFirst(3,
		"55 8B EC 6A ?? 68 ?? ?? ?? ?? 64 ?? ?? ?? ?? ?? 50 83 EC ?? A1 C4 ?? ?? ?? 33 C5 ?? 45 ?? 53 56 57 50 8D ?? ?? ?? A3 ?? ?? ?? ?? ?? 4D ?? 8B ?? 8B ?? ?? 8B ?? ?? 53",
	...
	pointerMap[Sigs::CBaseFileIO_OpenFile] = Signatures::FindFirst(3,
		"55 8B EC 6A ?? 68 ?? ?? ?? ?? 64 ?? ?? ?? ?? ?? 50 83 EC ?? A1 C4 ?? ?? ?? 33 C5 ?? 45 ?? 53 56 57 50 8D ?? ?? ?? A3 ?? ?? ?? ?? ?? 4D ?? 8B ?? 8B ?? ?? 8B ?? ?? 57",
